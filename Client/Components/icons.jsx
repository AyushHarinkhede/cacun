...
export function IconVanie() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        d="M12 2.8l7.3 4.2v8.4L12 19.6 4.7 15.4V7L12 2.8Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path
        d="M8.4 12c2.1 1.9 5.1 1.9 7.2 0"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
      <path d="M9.2 10.2h.01M14.8 10.2h.01" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" />
    </svg>
  )
}
...
export function IconMic() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M8 19h8" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect
        ...
        strokeLinejoin="round"
      />
      <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <path
        ...
        strokeLinejoin="round"
      />
      <rect x="2" y="9" width="4" height="12" stroke="currentColor" strokeWidth="1.6" rx="1" />
...
export function IconFacebook() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M16.5 12.5h-3v-2.5c0-.5.5-1 1-1h2v-3h-3c-1.5 0-3 1.5-3 3v3h-2v3h2v6h3v-6h2l1-3z" fill="#fff" />
    </svg>
  )
}
...
export function IconApple() {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2.77.79-3.31.79-1.51 0-2.65-.79-3.31-.79-1.37 0-2.66.79-3.29.79-1.34.02-2.23-1.23-3.05-2.47-.82-1.24-1.48-2.64-1.48-2.64s-1.66 1.4-2.48 2.64c-.82 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2.77.79-3.31.79-1.51 0-2.65-.79-3.31-.79-1.37 0-2.66.79-3.29.79-1.34.02-2.23-1.23-3.05-2.47z" fill="#fff" />
      <path d="M12.027 2.5c.88 0 1.58.72 1.58 1.6 0 .88-.7 1.6-1.58 1.6-.88 0-1.58-.72-1.58-1.6 0-.88.7-1.6 1.58-1.6z" fill="#fff" />
    </svg>
  )
}
  ...
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <rect
        ...
        strokeLinejoin="round"
      />
      <path d="m22 7-10 5L2 7" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
